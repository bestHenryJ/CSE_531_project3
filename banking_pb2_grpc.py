...
class BankStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MsgDelivery = channel.unary_unary(
                '/Bank/MsgDelivery',
                request_serializer=banking__pb2.MsgRequest.SerializeToString,
                response_deserializer=banking__pb2.MsgResponse.FromString,
                )
...
def add_BankServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MsgDelivery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=banking__pb2.MsgRequest.FromString,
                    response_serializer=banking__pb2.MsgResponse.SerializeToString,
            ),
    }
...
class Bank(object):
    ...
    def MsgDelivery(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Bank/MsgDelivery',
            banking__pb2.MsgRequest.SerializeToString,
            banking__pb2.MsgResponse.FromString,
